...
return [
    ...
    'app_api_task_create' => [[], ['_controller' => 'App\\Controller\\Api\\TaskController::create'], [], [['text', '/api/tasks']], [], [], []],
    'app_api_task_update' => [['id'], ['_controller' => 'App\\Controller\\Api\\TaskController::update'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/api/tasks']], [], [], []],
    'app_api_task_delete' => [['id'], ['_controller' => 'App\\Controller\\Api\\TaskController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/api/tasks']], [], [], []],
